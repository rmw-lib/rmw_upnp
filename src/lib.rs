...
pub async fn upnp_daemon(name: &str, port: u16, sleep_seconds: u32) {
  upnp_daemon_watch(name, port, sleep_seconds, Log).await;
}

pub async fn upnp_daemon_watch(name: &str, port: u16, sleep_seconds: u32, watch: impl Watch) {
